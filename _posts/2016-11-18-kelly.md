...
$$\begin{align}\frac{\partial L}{\partial q^i_j} &= \frac{p^i_j}{q^i_j} - \lambda \\ &= 0\text{,}\end{align}$$

so $$q^i_j = p^i_j / \lambda$$, and

$$\begin{align}\frac{\partial L}{\partial \lambda} &= \sum_j q^i_j - 1 \\ & = 0\text{,}\end{align}$$
