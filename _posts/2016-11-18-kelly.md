...
$$\begin{align} U &= q\log ((1-f)W + fW/p) + (1-q) \log ((1-f)W) \\ &= q \log(1 - f + f/p) + (1-q) \log (1-f) + \log (W)\text{.} \end{align}$$

The derivative of this with respect to $$f$$ is
$^$\frac{\partial U}{\partial f} = (q/(1-f + f/p))(1/p - 1) - (1-q)/(1-f)\text{.}$^$
...
$^$\text{Wealth} = (1-f+f/p)^K (1-f)^{N-K} W \text{.}$^$
The derivative of this with respect to $$f$$ is

$$\begin{align} \frac{\partial \text{Wealth}}{\partial f} &= W\left( K(1-f+f/p)^{K-1}(1/p - 1)(1-f)^{N-K} \right. \\ &\quad \left. {} - (1-f+f/p)^K (N-K)(1-f)^{N-K-1}\right) \text{.} \end{align}$$
...
$^$L(q^i, \lambda) = \sum_j p^i_j \log (W^i q^i_j / p^m_j) - \lambda ( \sum_j q^i_j - 1)\text{.}$^$
Taking partial derivatives,

$$\begin{align}\partial L/\partial q^i_j &= p^i_j/q^i_j - \lambda \\ &= 0\text{,}\end{align}$$

so $$q^i_j = p^i_j / \lambda$$, and

$$\begin{align}\partial L/\partial \lambda &= \sum_j q^i_j - 1 \\ & = 0\text{,}\end{align}$$
